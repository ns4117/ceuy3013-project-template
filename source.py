...
class Channel:
    ...
    as a decimal (e.g. 6% slope gets passed as 0.06), and the flowrate q in ft3/s
    ...
    def norm_depth(self):
        ...
        width b (ft), side slopes zleft and zright, Manning's n, the longitudinal 
    ...
    def crit_depth(self):
        ...
        the bottom width b (ft), side slopes zleft and zright, and the flowrate q 
        (cfs) to convey. For a rectangular channel, input zleft=zright=0, 
